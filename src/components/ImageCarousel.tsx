...
const ImageCarousel: React.FC<ImageCarouselProps> = ({ images }) => {
  ...
  return (
    ...
    >
      {!isLoading &&
        <div className="flex justify-center">
          <img
            ...
            className="w-full h-60 sm:h-72 object-cover rounded-lg shadow-lg ease-in-out"
          />
          <button
            onClick={prevImage}
      ...
      {isLoading &&
        <div className="flex justify-center bg-neutral-100 rounded-lg drop-shadow-lg" role="status">
          <svg
            aria-hidden="true"
            className="w-12 h-12 my-24 md:my-[7.5rem] animate-spin text-neutral-200 fill-green-500"
            viewBox="0 0 100 101"
            fill="none"
